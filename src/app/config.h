...
public:
    //扇贝词典版本信息
    QString versioninformation=QObject::tr("扇贝词典2.0.0");
    ...
    QString licenceinformation=QObject::tr("<h2>%1</h2>"
                                         ...
                                         "英文阅读、炼句、听力以及背单词服务。<br> "
                                         "Copyright(C) 2016 Lieefu Way  All rights reserved.<br>"
                                         "<p>完全遵循LGPL v3协议,未经作者允许不得作为商业用途。<a href='http://git.oschina.net/lieefu/ShanbayDict'><b>扇贝词典开源网址(码云)</b></a></p>"
